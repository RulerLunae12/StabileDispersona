...
define gui.accent_color = '#768A93'
...
define gui.muted_color = '#28363c'
define gui.hover_muted_color = '#00457a'
...
############### Тут помещаем стиль для словаря ######################
